...
Pre-trained mashine learning models were provided by [Saafke](https://github.com/Saafke/EDSR_Tensorflow/commits?author=Saafke) via his GitHub. Link to his repository is available [here](https://github.com/Saafke/EDSR_Tensorflow/tree/master).
